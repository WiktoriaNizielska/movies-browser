...
import { processPeopleCastMoviesData, processPeopleCrewMoviesData } from "./processAPIData";
...
function* fetchDetailsHandler() {
	try {
		...
		yield all([
			...
			put(setPeopleCastMovies(processedCastMovies)), 
			put(setPeopleCrewMovies(processedCrewMovies)), 
